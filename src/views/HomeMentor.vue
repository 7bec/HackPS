    ...
    div.content
      ...
      v-ons-row(width='100%' style='padding: 32px 0 8px 0;')
        v-row.font3(no-gutters style='padding: 0; width: 100%;')
          v-col Área do mentor
          v-col(cols='auto' style='font-weight: 500; font-size: 14px;') Ver mais
      v-ons-row(width='100%' style='padding: 0 0 16px 0')
        v-row(style='padding: 0; margin-top:20px; width: 100%;')
          v-col(cols='12' style='padding: 4px')
            v-card.cardServices(to='/mentoriaAtual' dark style='border-radius: 10px; justify-content:center;text-align:center')
              v-ons-ripple
                div(style='height: 100%; width: 100%; padding: 8px 8px 8px 8px;')
                  ...
                  div.font5 Projeto atual
                  // div.font6 consultar
          v-col(cols='12' style='padding: 4px')
            v-card.cardServices(to='/solicitacoes' dark style='border-radius: 10px;text-align:center')
              v-ons-ripple
                div(style='height: 100%; width: 100%; padding: 8px 8px 8px 8px;')
                  svg(style="width:55px;height:55px" viewBox="0 0 24 24")
                  ...
                  div.font5(style='line-height: 16px') Solicitações de projeto
          v-col(cols='12' style='padding: 4px')
            v-card.cardServices(dark style='border-radius: 10px;text-align:center')
              v-ons-ripple
                div(style='height: 100%; width: 100%; padding: 8px 8px 8px 8px;')
                  svg(style="width:55px;height:55px" viewBox="0 0 24 24")
                  ...
                  div.font5(style='line-height: 16px') Meus projetos passados
          // v-col(cols='12' style='padding: 4px')
          //   v-card.cardServices(dark style='border-radius: 10px; text-align:center')
          //     v-ons-ripple
          //       div(style='height: 100%; width: 100%; padding: 8px 8px 8px 8px;')
