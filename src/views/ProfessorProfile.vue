    ...
    div.content
      v-ons-row(width='100%' vertical-align='top')
        ...
        v-card(flat tile height='300' style='width: 100%; overflow: hidden;')
          v-img(height='300' :src='instrutor.picture_url' style='-webkit-filter: blur(15px); -moz-filter: blur(15px); -o-filter: blur(15px); -ms-filter: blur(15px); filter: blur(15px);')
          v-container(style='padding: 20px 10px 10px 10px; position: absolute; top: 0; width: 100%; height: 100%;')
            ...
            v-row(no-gutters style='justify-content: space-around; height: 246px;')
              v-col(cols='auto' style='align-self: center;')
                ...
                div(style='font-size: 14px; color: #FFFFFF; font-weight: lighter; text-align: center; width: 130px;') {{instrutor.localizacao}}
                div(style='text-align: center; width: 130px;')
                  v-rating(color='#FFEB3B' background-color='#FFEB3B' half-increments readonly dense v-model='instrutor.rating' small)
              v-col(cols='auto' style='align-self: center;')
        ...
        v-ons-row(width='100%' vertical-align='top')
          v-row(no-gutters style='width: 100%; padding-left: 12px;')
            v-col(cols='12' style='font-size: 12px; font-weight: 600; color: #666666; height: 100%; line-height: 18px;')
              ...
              span(style='padding-left: 4px; font-weight: 500; display:inline-block;vertical-align:middle;') {{instrutor.instagram}}
